...
define("particle-hack/templates/about", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "onhOnjvh", "block": "{\"statements\":[[\"open-element\",\"article\",[]],[\"static-attr\",\"class\",\"p-about o-article-frame u-fill c-page\"],[\"flush-element\"],[\"text\",\"\\n\\n  \"],[\"open-element\",\"header\",[]],[\"static-attr\",\"class\",\"u-mt3 u-mb3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"h1\",[]],[\"static-attr\",\"class\",\"p-about__headline u-text-center\"],[\"flush-element\"],[\"text\",\"About Particle Hack\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"open-element\",\"section\",[]],[\"static-attr\",\"class\",\"u-pl3 u-pr3\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n      Particle physics, usually thought of as the domain of multi-million or -billion dollar\\n      accelerators and detectors, has a more approachable side. You can join in the search\\n      for a better understanding of the fundamental details of the universe in a variety of ways.\\n      \"],[\"open-element\",\"i\",[]],[\"flush-element\"],[\"text\",\"particlehack.org\"],[\"close-element\"],[\"text\",\" is designed simply as a directory of ways you can participate in particle\\n      physics, from simple experiments to do at home, through to more complex data analysis\\n      challenges in which you can take part.\\n    \"],[\"close-element\"],[\"text\",\"\\n\\n    \"],[\"append\",[\"helper\",[\"divider-dots\"],null,[[\"class\"],[\"c-page__divider-dots\"]]],false],[\"text\",\"\\n\\n    \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n      \"],[\"open-element\",\"i\",[]],[\"flush-element\"],[\"text\",\"particlehack.org\"],[\"close-element\"],[\"text\",\" is a volunteer-run site based on the idea of\\n      \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"class\",\"c-markup-link o-color-shifting o-underline-shifting\"],[\"static-attr\",\"href\",\"https://www.spacehack.org\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"\\n        Spacehack\\n      \"],[\"close-element\"],[\"text\",\"\\n      by Ariel Waldman and Lisa Ballard. It's curated by David Harris — a physicist, journalist,\\n      and artist who was previously founding editor-in-chief of\\n      \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"class\",\"c-markup-link o-color-shifting o-underline-shifting\"],[\"static-attr\",\"href\",\"http://www.symmetrymagazine.org\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"\\n        \"],[\"open-element\",\"i\",[]],[\"flush-element\"],[\"text\",\"Symmetry Magazine\"],[\"close-element\"],[\"text\",\"\\n      \"],[\"close-element\"],[\"text\",\"\\n      , an international particle physics magazine — and built by\\n      \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"class\",\"c-markup-link o-color-shifting o-underline-shifting\"],[\"static-attr\",\"href\",\"https://twitter.com/Brian_Sipple\"],[\"static-attr\",\"target\",\"_blank\"],[\"flush-element\"],[\"text\",\"\\n        Brian Sipple\\n      \"],[\"close-element\"],[\"text\",\"\\n      — a software engineer, animator, and avid science enthusiast.\\n    \"],[\"close-element\"],[\"text\",\"\\n\\n    \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n      Any suggestions you have for entries to be included on the site should be\\n      \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"class\",\"c-markup-link o-color-shifting o-underline-shifting\"],[\"static-attr\",\"href\",\"mailto:physicsdavid@gmail.com\"],[\"flush-element\"],[\"text\",\"emailed\"],[\"close-element\"],[\"text\",\" to David.\\n    \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "particle-hack/templates/about.hbs" } });
});
...
if (!runningTests) {
  require("particle-hack/app")["default"].create({"name":"particle-hack","version":"0.0.0+98546c0d"});
}
